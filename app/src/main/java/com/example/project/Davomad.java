...
public class Davomad extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_davomad);
        ...
        for(int  i=0;i<6;i++){
            ...
            for(int j=0;j<13;j++){
                ...
                if(i==0 || j==0){
                    ...
                    textView.setTextColor(0xFFC85A17);
                    int min = 0;
                    int max = 1;
                    int random_int = (int)(Math.random() * (max - min + 1) + min);
                    textView.setText(davomad[random_int]);
                }
